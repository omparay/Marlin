...
#define CUSTOM_MACHINE_NAME "Geppetto"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "a37ea267-e40c-4ed3-8b75-de437863cb32"
...
#define HOTEND_OFFSET_X {0.0, 35.00} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define  DEFAULT_bedKp 950.59
  #define  DEFAULT_bedKi 187.20
  #define  DEFAULT_bedKd 1206.77
 ...
 */
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 8000, 196 }
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 152, 158, 8000, 196, 196 }
